...
class AutoMDLMDraftModel(AutoModelForCausalLMBase):
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        """Load MDLM model from pretrained checkpoint."""
...
class AutoDraftModelConfig:
    ...
    _config_mapping = {
        ...
        "LlamaMDLMDraftModel": LlamaConfig,
        "Qwen3MDLMDraftModel": Qwen3Config,
    }
